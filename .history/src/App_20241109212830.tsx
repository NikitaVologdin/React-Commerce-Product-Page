    ...
    <section className="main__stock stock">
      ...
      <article className="stock-item">
        ...
        <div className="stock-item__amount amount-controller">
          <button className="amount-controller__button" onClick={decreaseHandler}>
            <img src="/public/images/icon-minus.svg" width={12} height={3} alt="" />
          </button>
          <span>{ctx.}</span>
          <button className="amount-controller__button" onClick={increaseHandler}>
            <img src="/public/images/icon-plus.svg" width={12} height={12} alt="" />
          </button>
        </div>
        <button className="">
        </button>
