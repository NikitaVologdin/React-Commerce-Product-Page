...
interface ICarouselProps {
  item: IStockItem;
  defaultIndex?: number;
  thumbNailDoubleClickHandler?: () => void;
}

export default function Carousel({ item, defaultIndex }: ICarouselProps) {
  ...
  useEffect(() => {
    if (defaultIndex) setImageIndex(defaultIndex);
  }, [defaultIndex]);
  ...
  return (
    <>
      ...
      <Thumbnails
        ...
        thumbNailDoubleClickHandler={thumbNailDoubleClickHandler}
      />
    </>
  );
}
