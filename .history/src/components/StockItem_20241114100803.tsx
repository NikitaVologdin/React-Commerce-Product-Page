  ...
  return (
    <>
      <article className="stock-item">
        ...
        <div className="stock-item__body item-body">
          <header className="item-body__header">
            <b className="item-body__manufacturer">{manufacturer}</b>
            <h1 className="item-body__title">{title}</h1>
            <p className="item-body__paragraph">{description}</p>
          </header>
